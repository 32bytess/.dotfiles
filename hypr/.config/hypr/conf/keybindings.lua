...
hl.bind("CTRL + Print",         hl.dsp.exec_cmd('mkdir -p ~/Pictures/Screenshots && grim ~/Pictures/Screenshots/$(date +%Y%m%d_%H%M%S).png'))
...
hl.bind(mod .. " + SHIFT + U",  hl.dsp.exec_cmd(home .. "/.local/bin/wallpaper-rofi"))
